...
send_customsettings = tk.Button(custom_page, text = "Play", width = 25, font = ('Helvetica', 14, BOLD), cursor = "hand2", bd = 0,fg = "white", bg = "#9D378C", command = lambda:[send_info(), switch_page(main_page)])
